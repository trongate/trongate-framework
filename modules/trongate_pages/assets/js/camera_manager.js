...
function tgpAfterUploadEventsMobi(response) {
  ...
  const targetModalBody = document.querySelector(`#tgp-camera-modal > div.modal-body`);
...
function tgpDrawImageErrorMobi(status, response) {
  console.log('running tgpDrawImageErrorMobi with status of ' + status + ' and response of ' + response);
}