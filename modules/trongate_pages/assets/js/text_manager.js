...
function tgpBuildLinkModal() {
    ...
    infoParaText = document.createTextNode('Enter link text and target URL below, then hit Submit.');
...
function tgpLinkify() {
    ...
    const linkTarget = document.getElementById('tgp-link-target').checked ? '_blank' : '_self';
