function tgpBuildInsertButtonModal() {
    ...
    buttonInputField.setAttribute('placeholder', 'Enter button ID or URL here...');
    buttonInputField.setAttribute('autocomplete', 'off');
...
function tgpToggleSecondaryBtnDiv() {
  ...
  const targetCheckbox = document.getElementById('ignore_secondary_btn_checkbox');
...
function tgpInsertButton() {
  const targetCheckbox = document.getElementById('ignore_secondary_btn_checkbox');
  const buttonInputFieldText1 = document.getElementById('button-input-field-text1');
  const buttonInputFieldUrl1 = document.getElementById('button-input-field-url1');
  const valueField1Text = buttonInputFieldText1.value.trim();
  const valueField1Url = buttonInputFieldUrl1.value.trim();

  const buttonInputFieldText2 = document.getElementById('button-input-field-text2');
  const buttonInputFieldUrl2 = document.getElementById('button-input-field-url2');
  ...
  if (valueField1Url !== '') {
    button1.setAttribute('onclick', 'window.location=\'' + valueField1Url + '\';')
  }
  ...
  if (targetCheckbox.checked !== true) {
    ...
    if (valueField2Url !== '') {
      button2.setAttribute('onclick', 'window.location=\'' + valueField2Url + '\';')
    }
  }
