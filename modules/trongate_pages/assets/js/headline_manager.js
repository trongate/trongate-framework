function tgpInsertHeadline() {
    ...
    let starterHeadlines = ["First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Another", "Yet Another"];
    let numStarterHeadlines = starterHeadlines.length;

    //how many headlines do we have
    let allHeadlines = trongatePagesObj.defaultActiveElParent.querySelectorAll('h1');
