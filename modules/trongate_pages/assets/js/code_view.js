function tgpOpenCodeViewModal() {
    ...
    codeViewModal.setAttribute("style", "z-index: 4; opacity: 1; margin-top: 12vh;");
    ...
    setTimeout(() => {
        ...
        const targetUrl = trongatePagesObj.baseUrl + 'trongate_pages/submit_beautify';
        ...
        http.onload = function() {
            if (http.status === 200) {
                ...
                const newTextarea = document.getElementById('content-as-code');
                newTextarea.value = document.getElementsByClassName('page-content')[0].innerHTML;
                newTextarea.style.opacity = 1;
            }
        }
    ...
    cancelButton.setAttribute("onclick", "closeAndDestoryModal('tgp-code-view-modal')");
    cancelButton.setAttribute("onclick", "tgpCloseAndDestroyModal('tgp-code-view-modal', 0)");
