...
class Trongate_tokens extends Trongate
{
    ...
    public function _get_user_id($token = null)
    {
        if (isset($token)) {
            ...
            $params['cookie_token'] = ($_COOKIE['trongatetoken'] ?? '');
            $params['session_token'] = ($_SESSION['trongatetoken'] ?? '');
        }
    ...
    public function _get_user_obj($token = null)
    {
        if (isset($token)) {
    ...
    public function _fetch_token_obj($token)
    {
        $data['token'] = $token;
    ...
    public function _pre_token_validation($input)
    {
    ...
    public function _generate_token($data)
    {
        /*
    ...
    public function _attempt_get_valid_token($user_levels = null)
    {
    ...
    public function _execute_sql_single($user_tokens, $user_levels)
    {
        //allow access for ONE user level type
    ...
    public function _execute_sql_multi($user_tokens, $user_levels)
    {
        //allow access for MORE THAN ONE user level type
        $where_condition = ' WHERE trongate_tokens.token = :token ';
        $params['nowtime'] = time();
    ...
    public function _execute_sql_default($user_tokens)
    {
        //allow access for ANY user level type
        $where_condition = ' WHERE trongate_tokens.token = :token ';
        $params['nowtime'] = time();
    ...
    public function _delete_old_tokens($user_id = null): void
    {
