...
class Trongate_administrators extends Trongate
{
    ...
    public function load_template($data): void
    {
    ...
    public function _get_my_id($token)
    {
        $params['token'] = $token;
    ...
    public function _log_user_in($username): void
    {
        $this->module('trongate_tokens');
    ...
    public function _delete_tokens_for_user($trongate_user_id): void
    {
    ...
    public function _delete_expired_tokens(): void
    {
        $params['nowtime'] = time();
    ...
    {
        return password_verify($plain_text_str, $hashed_string); //TRUE or FALSE
    }
    ...
    public function login_check($submitted_username)
    {
