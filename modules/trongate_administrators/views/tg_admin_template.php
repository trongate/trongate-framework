...
<body>
    ...
    <div id="top-gutter">
        <div>
            <a href="<?php echo BASE_URL ?>trongate_administrators/go_home">
                <span class="hide-sm">Home</span>
                <i class="fa fa-home"></i>
            </a>
        </div>
        <div>
            <a href="<?php echo BASE_URL ?>trongate_administrators/manage">
                <span class="hide-sm">Manage Administrators</span>
                <i class="fa fa-gears"></i>
            </a>
            <a href="<?php echo BASE_URL ?>trongate_administrators/create/<?php echo $data['my_admin_id'] ?>">
                <span class="hide-sm">Your Account</span>
                <i class="fa fa-user"></i>
            </a>
            <a href="<?php echo BASE_URL ?>trongate_administrators/logout">
    ...
    ?>
    <div class="container">
        <?php echo Template::display($data) ?>
    </div>
<style>
body {
