...
<body>
    ...
    foreach ($endpoints as $endpoint_name => $endpoint_row) {
        ...
        ?>
                        <tr class="row-<?php echo strtolower($request_type) ?>">
                            <td>
                                <button id="btn-<?php echo $btn_key ?>" class="<?php echo $btn_class ?>" data-row="<?php echo $counter ?>">
                                    <?php echo $endpoint_row['request_type'] ?>
                                </button>
                            </td>
                            <td><?php echo $endpoint_name ?></td>
                            <td><?php echo $endpoint_row['url_segments'] ?></td>
                            <td><?php echo $endpoint_row['description'] ?></td>
                        </tr>
                        <?php
    }
    ?>
