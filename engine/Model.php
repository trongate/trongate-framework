...
class Model
{
    ...
    public function get_many_where($column, $value, $target_tbl = null)
    {
        ...
        return $this->query_bind($sql, $data, 'object');
    }
    ...
    public function show_query($query, $data, $caveat = null): void
    {
        $keys = [];
        $values = $data;
        $named_params = true;
...
<?php
    ...
    public function update($update_id, $data, $target_tbl = null): void
    {
        if (! isset($target_tbl)) {
            $target_tbl = $this->get_table_from_url();
        }
    ...
    public function update_where($column, $column_value, $data, $target_tbl = null): void
    {
        if (! isset($target_tbl)) {
            $target_tbl = $this->get_table_from_url();
        }
    ...
    public function delete($id, $target_tbl = null): void
    {
        if (! isset($target_tbl)) {
            $target_tbl = $this->get_table_from_url();
        }
    ...
    public function attempt_truncate($tablename): void
    {
